...
namespace aldy\Aliyun\Core\Profile;

use aldy\Aliyun\Core\Auth\Credential;
use aldy\Aliyun\Core\Auth\ShaHmac1Signer;
use aldy\Aliyun\Core\Regions\ProductDomain;
use aldy\Aliyun\Core\Regions\Endpoint;
use aldy\Aliyun\Core\Regions\EndpointProvider;
