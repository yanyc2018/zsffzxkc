<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:78:"/www/wwwroot/test1.sxjiangyan.com/public/../application/admin/view/set/h5.html";i:1606658624;}*/ ?>
<!DOCTYPE html>
<html>
                ...
                <form class="layui-form" id="formBasForm" lay-filter="formBasForm">
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <input name="title" class="layui-input" value="<?php echo $item['title']; ?>" />
                        </div>
                    </div>
                    <div class="layui-form-item">
                        <label class="layui-form-label layui-form-required">域名:</label>
                        <div class="layui-input-block">
                            <input name="url" class="layui-input" value="<?php echo $item['url']; ?>" lay-verify="required" required placeholder="https://h5.sxjiangyan.com" />
                        </div>
                    </div>
                    <div class="layui-form-item">
                        <label class="layui-form-label">APPID:</label>
                        <div class="layui-input-block">
                            <input name="appid" class="layui-input" value="<?php echo $item['appid']; ?>" />
                        </div>
                    </div>
                    <div class="layui-form-item">
                        <label class="layui-form-label">APPSecret:</label>
                        <div class="layui-input-block">
                            <input name="appsecret" class="layui-input" value="<?php echo $item['appsecret']; ?>" />
                        </div>
                    </div>
                    <div class="layui-form-item">
                        <label class="layui-form-label">商户号:</label>
                        <div class="layui-input-block">
                            <input name="mchid" class="layui-input" value="<?php echo $item['mchid']; ?>" />
                        </div>
                    </div>
                    <div class="layui-form-item">
                        <label class="layui-form-label">支付密钥:</label>
                        <div class="layui-input-block">
                            <input name="paysecret" class="layui-input" value="<?php echo $item['paysecret']; ?>" />
                        </div>
                    </div>
                    <div class="layui-form-item">
