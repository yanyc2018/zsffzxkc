<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:81:"/www/wwwroot/test1.sxjiangyan.com/public/../application/admin/view/vip/index.html";i:1606658626;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8"/>
...
<script>
    layui.use(['layer', 'table','index'], function () {
        ...
        var insTb=table.render({
            elem: '#tbImgTable',
            url: "<?php echo url('admin/vip/index'); ?>",
            page: true,
            cellMinWidth: 100,
            cols: [[
        ...
        table.on('tool(tbImgTable)', function (obj) {
            ...
            if (layEvent == 'edit') {
                index.openTab({
                    title: '编辑讲师',
                    url: "<?php echo url('add_vip'); ?>?id="+data.id,
                });
