<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:84:"/www/wwwroot/test1.sxjiangyan.com/public/../application/admin/view/shop/comment.html";i:1606658624;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8"/>
...
<script>
    layui.use(['layer', 'table','index'], function () {
        ...
        var insTb=table.render({
            elem: '#tbImgTable',
            url: "<?php echo url('admin/shop/comment'); ?>",
            page: true,
            cellMinWidth: 100,
