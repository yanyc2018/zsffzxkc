<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:80:"/www/wwwroot/test1.sxjiangyan.com/public/../application/admin/view/shop/ads.html";i:1606658624;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8"/>
                ...
                <div class="layui-form toolbar">
                    <div class="layui-form-item">
                        ...
                        <div class="layui-inline">
                            ...
                            <a ew-href="<?php echo url('ads_add'); ?>" ew-title="新增幻灯片">
...
<script>
    layui.use(['layer', 'table','index'], function () {
        ...
        var insTb=table.render({
            elem: '#tbImgTable',
            url: "<?php echo url('admin/shop/ads'); ?>",
            page: true,
            cellMinWidth: 100,
            ...
            cols: [[
                ...
                {field: 'title', title: '幻灯片名称', align: 'center'},
                {
                    title: '幻灯片图片', templet: function (d) {
                        var url = d.thumb || '../../../assets/images/head.jpg';
                        return '<img src="' + url + '" class="tb-img-circle" tb-img alt=""/>';
                    }, align: 'center', unresize: true
                },
                {field: 'shoptype_name', title: '归属', align: 'center'},
                {field: 'gzh_src', title: '公众号链接', align: 'center'},
                {field: 'xcx_src', title: '小程序链接', align: 'center'},
        ...
        table.on('tool(tbImgTable)', function (obj) {
            ...
            if (layEvent == 'edit') {
                index.openTab({
                    title: '编辑幻灯片',
                    url: "<?php echo url('ads_add'); ?>?id="+data.id,
                });
