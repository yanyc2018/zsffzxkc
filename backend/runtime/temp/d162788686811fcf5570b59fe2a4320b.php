<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:85:"/www/wwwroot/test1.sxjiangyan.com/public/../application/admin/view/teacher/index.html";i:1606658626;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8"/>
            ...
            <div class="layui-form toolbar">
                <div class="layui-form-item">
                    ...
                    <div class="layui-inline">
                        ...
                        <a ew-href="<?php echo url('add_teacher'); ?>" ew-title="添加讲师">
                            <button class="layui-btn icon-btn" type="button">
                                <i class="layui-icon">&#xe654;</i>新增
                            </button>
                        </a>
                        <a ew-href="<?php echo url('dsh'); ?>" ew-title="待审核讲师">
                            <button class="layui-btn icon-btn" type="button">
...
<script>
    layui.use(['layer', 'table','index'], function () {
        ...
        var insTb=table.render({
            elem: '#tbImgTable',
            url: "<?php echo url('admin/teacher/index'); ?>",
            page: true,
            cellMinWidth: 100,
            cols: [[
        ...
        table.on('tool(tbImgTable)', function (obj) {
            ...
            if (layEvent == 'edit') {
                index.openTab({
                    title: '编辑讲师',
                    url: "<?php echo url('add_teacher'); ?>?id="+data.id,
                });
