<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:82:"/www/wwwroot/test1.sxjiangyan.com/public/../application/admin/view/user/index.html";i:1606658624;s:75:"/www/wwwroot/test1.sxjiangyan.com/application/admin/view/public/header.html";i:1606658628;s:75:"/www/wwwroot/test1.sxjiangyan.com/application/admin/view/public/footer.html";i:1606658628;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<div class="layui-fluid">
    <div class="layui-card">
        <div class="layui-form layui-card-header layuiadmin-card-header-auto" id="LAY-user">
            ...
            <div>
                <button class="layui-btn icon-btn" data-type="add" onclick="wk.layer_show('添加管理员','<?php echo url('userAdd'); ?>')">
